## The Great Song Logger

It is an emote logger for the great song puzzle.  It is primary in experimental phase for now.
The command '/elog' allowed it to display the logger and '/elog help' shows different commands that you can use. 
...
/elog - Toggle log window

/elog clear - Clear the log

/elog seq <playername> - View sequences for a player

/elog viewallsequences - View all completed sequences
